...
from DSM_functions import examples
...
pointdata, centroiddata = DSM_functions.get_pointcloud('Rectum', RSfile)
...
verts, faces, pvfaces = DSM_functions.get_cubemarch_surface(pointdata, imgres)
...
slices = DSM_functions.sample_planar_slices(surf, centroiddata, slicelocs, 45)
...
dosegrid, xs, ys, zs = DSM_functions.get_doseinfo(RDfile)
# Calculate the DSM 
dosemap = DSM_functions.sample_dsm(slices, slicelocs, dosegrid, xs, ys, zs)
